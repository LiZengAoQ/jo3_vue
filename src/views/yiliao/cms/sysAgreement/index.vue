<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="作者姓名" align="center" prop="author"/>
<!--      <el-table-column label="是否置顶" align="center" prop="fgTop"/>-->
      <el-table-column label="是否置顶" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.fgTop == 0">否</span>
          <span v-else>是</span>
        </template>
      </el-table-column>
...
<!--          <el-input v-model="form.content" type="textarea" placeholder="请输入资讯内容"-->
        ...
        this.$refs['form'].validate((valid) => {
          if (valid) {
            if (this.form.id != null) {
              ...
              this.form.fgTop = '0'
              this.form.moduleId = 'sys_agreement' //sys_agreement指的是 系统协议
              this.form.titleImg = this.titleImg
