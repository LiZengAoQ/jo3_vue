<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="药房名称" prop="hosName">
        <el-input
      ...
      <el-form-item label="药房状态" prop="fgActive">
        <el-select
    ...
    >
      ...
      <el-table-column label="药房编号" align="center" prop="hosId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="药房编号" prop="hosId">
          <el-input
            v-model="form.hosId"
            placeholder="请输入药房编号"
            :readonly="readonly"
        ...
        <el-form-item label="药房名称" prop="hosName">
          <el-input v-model="form.hosName" placeholder="请输入药房名称" />
        </el-form-item>
        <el-form-item label="药房地址" prop="addr">
          <el-input v-model="form.addr" placeholder="请输入药房地址" />
        </el-form-item>
        <el-form-item label="药房电话" prop="hosTel">
          <el-input v-model="form.hosTel" placeholder="请输入药房电话" />
        </el-form-item>
        ...
        <el-form-item label="药房图片" prop="hosPic">
...
<!--          </el-upload>-->
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitFormInsert">确 定</el-button>
...
import {
  ...
  updateHosData,
  exportHosData,
} from "@/api/yiliao/recipe/hosData";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        longitude: [
          { required: true, message: "药房经度不能为空", trigger: "blur" },
        ],
        latitude: [
          { required: true, message: "药房纬度不能为空", trigger: "blur" },
        ],
        hosId: [
          { required: true, message: "药房编号不能为空", trigger: "blur" },
        ],
        addr: [
          { required: true, message: "药房地址不能为空", trigger: "blur" },
        ],
        hosTel: [
          { required: true, message: "药房电话不能为空", trigger: "blur" },
        ],
    ...
    handleUpdate(row) {
      ...
      getHosData(hosId).then((response) => {
        ...
        if(response.data.hosPic != null){
          ...
          this.fileList = [{ url: response.data.hosPic}];
        }
        if(response.data.hosPic == null){
          this.fileList = [];
        }
    ...
    submitFormInsert() {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.hosId != null) {
            this.form.hosPic = this.hosPic;
            console.log(this.hosPic,111111111);
