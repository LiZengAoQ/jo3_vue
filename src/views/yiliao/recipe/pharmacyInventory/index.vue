    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="库存" prop="hosName">
                <el-select v-model="fgHave" clearable size="small">
            ...
            <el-form-item label="所属医院" prop="hosName">
                <el-select v-model="hosId" placeholder="请选择所属医院" clearable size="small">
                    <el-option
...
export default {
    ...
    methods: {
        ...
        async getListOne() {
            ...
            this.hosId = this.hosList[0].hosId//设置下拉列表默认值
            this.queryParams.hosId = this.hosId
            this.fgHave = '1'//默认设置展示有库存的药品 0为没库存
            this.queryParams.fgHave = this.fgHave
        ...
        /** 提交按钮 */
        submitForm() {
            this.queryParams.drugId = this.rhdId
            this.queryParams.fgHave = this.form.fgHave
            this.queryParams.hosId = this.hosId
            updateFgHave(this.queryParams).then(response => {
