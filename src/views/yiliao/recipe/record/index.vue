<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="药品类型" align="center" prop="drugType" :formatter="statusType"/>
            <el-table-column label="药品编号" align="center" prop="drugCode"/>
            <el-table-column label="药品名称" align="center" prop="drugName"/>
            <el-table-column label="药品英文名" align="center" prop="drugEnglishName"/>
            <el-table-column label="原价格" align="center" prop="oldPrice"/>
            ...
            <el-table-column label="操作时间" align="center" prop="dtCreate" width="180">
                <template slot-scope="scope">
                    <span>{{ parseTime(scope.row.dtCreate) }}</span>
                </template>
            </el-table-column>
            <el-table-column label="操作人" align="center" prop="createrName"/>
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="原价格" prop="oldPrice">
                    <el-input v-model="form.oldPrice" placeholder="请输入原价格"/>
                </el-form-item>
                ...
                <el-form-item label="创建人id" prop="createrId">
                    <el-input v-model="form.createrId" placeholder="请输入创建人id"/>
                </el-form-item>
                <el-form-item label="创建人" prop="createrName">
                    <el-input v-model="form.createrName" placeholder="请输入创建人"/>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        handleDelete(row) {
            ...
            this.$confirm('是否确认删除处方_价格变更记录编号为"' + ids + '"的数据项?', '警告', {
        ...
        handleExport() {
            ...
            this.$confirm('是否确认导出所有处方_价格变更记录数据项?', '警告', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(function() {
