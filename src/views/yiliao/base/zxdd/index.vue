<template>
    <div class="app-container" style="padding: 60px;">
        ...
        <p style="text-align: center;">咨询统计</p>
        ...
        >
            ...
            <el-table-column label="图文咨询">
                <el-table-column prop="p1" label="待受理" width="60">
                </el-table-column>
                <el-table-column prop="p2" label="进行中" width="60">
                </el-table-column>
                <el-table-column prop="p3" label="已结束" width="60">
                </el-table-column>
                <el-table-column prop="p4" label="已取消" width="60">
                </el-table-column>
            </el-table-column>
            <el-table-column label="总数" align="center" prop="p5" />
        </el-table>
