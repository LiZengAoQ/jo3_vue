<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="3d病例库id" prop="abbrId">
        <el-input
          v-model="queryParams.abbrId"
          placeholder="请输入3d病例库id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="collectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收藏 (病例)" align="center" prop="collectId" />
      <el-table-column label="医生id" align="center" prop="docId" />
      <el-table-column label="3d病例库id" align="center" prop="abbrId" />
      <el-table-column label="收藏日期" align="center" prop="collectTime" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="3d病例库id" prop="abbrId">
          <el-input v-model="form.abbrId" placeholder="请输入3d病例库id" />
        </el-form-item>
        <el-form-item label="收藏日期" prop="collectTime">
        ...
        <el-form-item label="是否删除收藏" prop="delFlag">
          <el-input v-model="form.delFlag" placeholder="请输入是否删除收藏" />
        </el-form-item>
      </el-form>
...
<script>
import { listCollect, getCollect, delCollect, addCollect, updateCollect, exportCollect } from "@/api/physician/sdcase/collect/collect";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除3d病例扩展，收藏编号为"' + collectIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有3d病例扩展，收藏数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
