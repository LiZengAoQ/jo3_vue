            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="菜单权限">
                    <el-checkbox
                        ...
                        @change="handleCheckedTreeExpand($event, 'permission')"
                    >
                        展开/折叠
                    </el-checkbox>
                    <el-checkbox
                        v-model="permissionNodeAll"
                        @change="handleCheckedTreeNodeAll($event, 'permission')"
                    >
                        全选/全不选
                    </el-checkbox>
                    <el-checkbox
                        v-model="form.permissionCheckStrictly"
                        @change="handleCheckedTreeConnect($event, 'permission')"
                        >父子联动
                    </el-checkbox>
                    <el-tree
                        class="tree-border"
