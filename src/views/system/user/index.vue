    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="部门" align="center" key="name" prop="dept.name" v-if="columns[3].visible" :show-overflow-tooltip="true" />
          ...
          <el-col :span="12">
            <el-form-item label="用户性别">
              <el-select v-model="form.sex" placeholder="请选择">
                <el-option
                  v-for="dictionary in sexOptions"
                  :key="dictionary.name"
                  :label="dictionary.name"
                  :value="dictionary.data"
                ></el-option>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      getDictionarys("sys_user_sex").then(response => {
